...
public class Scores implements Parcelable {
    public static final int constie = 1000;
    ...
    public Scores scaleWith(float scale) {
        return new Scores(anger * scale, contempt * scale, disgust * scale, fear * scale,
                happiness * scale, neutral * scale, sadness * scale, surprise * scale);
    }
